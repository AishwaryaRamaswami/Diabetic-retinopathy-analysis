...
#    ImagePath = "C:\\Users\\Imran Ullah\\Desktop\\FYP\\GUI - FYP2\\Images\\6_left-grayscale.png"
    ...
    def __init__(self, mainObj, MainWin, wWidth, wHeight, function, Object, xAxis = 10, yAxis = 10):
        ...
        global winFrame
        self.winFrame = Frame(self.MainWindow, width = wWidth, height = wHeight)
        ...
        self.btnQuit= Button(self.winFrame, text = "Close", width=8, command= lambda: self.quitProgram(self.MainWindow))
        self.btnQuit.place(x=650, y=450)
        self.btnNext = Button(self.winFrame, text = "Next", width=8, command= lambda: self.NextWindow(self.method))
    ...
    def displayImage(self):
        ...
        self.image = imgTk
        self.labelImg = Label(self.winFrame, image = self.image)
